...
- Human decisions are separate from automated statuses: Accept, Needs review, or Reject are session-local, switchable, shown as colored queue dots, and exported without overwriting Match/Mismatch/Review.
